...
# -------------------------
# TODO: 直接用你之前的 handle_server_welcome, connect_to_other_server, handle_server_announce, handle_user_advertise, handle_user_remove
# （这里省略，可以把你那份 server↔server 逻辑粘过来，直接替换）
